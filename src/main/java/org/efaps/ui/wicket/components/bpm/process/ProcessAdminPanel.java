    ...
    extends Panel
{
    ...
    {
        super(_wicketId);
        final Form<UIProcessInstanceLog> form = new Form<>("form");
        add(form);
        final DropDownChoice<String> dropDown = new DropDownChoice<>("processIds", Model.<String>of(),
        ...
        dropDown.add(new AjaxFormComponentUpdatingBehavior("change")
        {
            ...
            {
                getPage().visitChildren(AjaxFallbackDefaultDataTable.class, (_table, _visit) -> {
                    final IDataProvider<?> provider = ((AjaxFallbackDefaultDataTable<?, ?>) _table).getDataProvider();
